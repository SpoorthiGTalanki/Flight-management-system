package com.flight.backend.security.cookie;
...
public class CookieService {
    ...
    public String extractRefreshToken(HttpServletRequest request) {
        ...
        // 1. Try standard Servlet getCookies()
        ...
        // 2. Fallback: Parse raw "Cookie" header if request.getCookies() returned null or missing
